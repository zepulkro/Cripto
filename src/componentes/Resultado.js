...
class Resultado extends Component {
    ...
    mostrarResultado = () => {
        ...
        if(!name) return null;
        if(monedaCotizada!=='USD') {
            return(
                <div className="bg-success py-4">
                    <div className="resumen text-light text-center">
                        <h2 className="mb-4">Lo sentimos</h2>
                        <p><span className="font-weight-bold">La API Actualmente Solo Está Funcionando Con Dólares Estadounidenses.</span></p>
                    </div>
                </div>
            )
        };
        ...
        return(            
            <div className="bg-success py-4">
                <div className="resumen text-light text-center">
                    ...
                    <p><span className="font-weight-bold">Procentaje Última hora:</span> {percent_change_1h}%</p>
